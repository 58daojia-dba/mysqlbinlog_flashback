...
class BinLogStreamReader(object):
    ...
    def fetchone(self):
        while True:
            ...
            #added by yilai
            #print("*****timestamp{0},next pos{1}".format(binlog_event.timestamp,
            ...
            if  self.process_interval>0:
                if (self.event_count %  self.process_interval)==0:
                    stm="scan {0} events ....from binlogfile={1},timestamp={2}".format(self.event_count,self.log_file,datetime.fromtimestamp(binlog_event.timestamp).isoformat())
                    print(stm)
